 ...
 * @author lstar
 * @create 2025-02
 * @description: 模态对话框内容面板
 */
public class ModalContentDialogPane extends ModalDialog {
    ...
    public ModalContentDialogPane() {
        this(null, null, null);
    }

    public ModalContentDialogPane(String title) {
        this(null, title, null);
    }

    public ModalContentDialogPane(String title, Node body) {
        this(null, title, body);
    }

    public ModalContentDialogPane(Node icon, String title, Node body) {
        super();
        actionsOrientationProperty().addListener(invalidated -> buildActionsPane());
        buildActionsPane();
        setId("modal-content-dialog-pane");
